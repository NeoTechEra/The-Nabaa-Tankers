...
import { Tag, Sparkles, Check, ArrowRight, Percent, Gift, AlertCircle } from 'lucide-react';
import { AUTO_PROMOTIONS, PROMO_CODES } from '../data/mockData';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-950/60 border border-cyan-500/30 text-cyan-300 text-xs font-semibold uppercase tracking-wider">
            ...
            <span>Smart Discount Engine</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white font-display tracking-tight">
            Better Orders. Better Offers.
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-7 space-y-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white font-display">1. Automatic Promotions</h3>
                  <p className="text-xs text-slate-400">Auto-calculated and applied at checkout without manual entry</p>
                </div>
              </div>
                ...
                {AUTO_PROMOTIONS.map((promo) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-sm font-bold font-display text-white">{promo.title}</div>
                      <div className="text-xs text-slate-400 mt-1">{promo.description}</div>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-7 space-y-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white font-display">2. Promo Codes</h3>
                  <p className="text-xs text-slate-400">Special event codes and promotional voucher redemption</p>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-2">
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="Enter code (e.g. WATERFAST)"
          ...
          <div className="lg:col-span-5 bg-gradient-to-b from-[#0a1832] to-[#071124] border border-cyan-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-6">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <span className="text-xs font-mono uppercase text-slate-400">Live Order Calculation</span>
              <span className="text-xs font-bold text-cyan-400">Interactive Checkout</span>
            </div>

            <div className="space-y-3">
              <div className="text-xs text-slate-400 uppercase font-semibold">Configured Order Item</div>
              <div className="p-3.5 rounded-xl bg-slate-900/90 border border-slate-800 flex justify-between items-center">
                <div>
                  <div className="text-sm font-bold text-white font-display">19T Medium Tanker</div>
                  <div className="text-xs text-slate-400">19,000 Liters • Villa Delivery</div>
                </div>
                <div className="text-base font-mono font-bold text-white">200 SAR</div>
              </div>
            </div>
            ...
            <div className="space-y-3 border-t border-slate-800/80 pt-4 text-xs">
              ...
              {selectedAutoPromo === 'seasonal' && (
                <div className="flex justify-between text-emerald-400 bg-emerald-950/40 p-2.5 rounded-lg border border-emerald-500/30">
                  <span>Seasonal Water Offer (15%)</span>
                  <span className="font-mono font-bold">-30 SAR</span>
                </div>
              )}

              {selectedAutoPromo === 'welcome' && (
                <div className="flex justify-between text-emerald-400 bg-emerald-950/40 p-2.5 rounded-lg border border-emerald-500/30">
                  <span>First Order Welcome</span>
                  <span className="font-mono font-bold">-25 SAR</span>
                </div>
              )}

              {activePromoCode && (
                <div className="flex justify-between text-emerald-400 bg-emerald-950/40 p-2.5 rounded-lg border border-emerald-500/30">
                  <span>Promo Code ({activePromoCode})</span>
                  <span className="font-mono font-bold">-{codeDiscount} SAR</span>
                </div>
              )}
              ...
              <div className="flex justify-between text-base font-extrabold text-white pt-3 border-t border-slate-800">
                ...
                <span className="text-xl font-mono text-cyan-400">{finalTotal} SAR</span>
              </div>
            </div>
