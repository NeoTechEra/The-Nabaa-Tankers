...
import { Droplets, Building2, ArrowRight, CheckCircle2, Shield, Phone, Sparkles, MessageCircle, Mail } from 'lucide-react';
    ...
    <section className="py-20 lg:py-28 relative bg-[#070e1c] border-t border-slate-800/80 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2.5 mb-8 text-xs text-slate-300">
                <div className="flex items-center gap-2">
                  ...
                  <span>Immediate dispatch or scheduled arrival</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-400 shrink-0" />
                  <span>10T, 19T, 32T potable certified tankers</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-400 shrink-0" />
                  <span>Mada, Apple Pay, cards, or Cash on Delivery</span>
                </div>
              </div>
            </div>
          ...
          {/* Section 28: FOR WATER DELIVERY BUSINESSES */}
          <div className="relative p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-[#0c1f3c] via-[#09152b] to-[#070e1c] border border-blue-500/30 shadow-2xl flex flex-col justify-between overflow-hidden">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-950 text-blue-300 text-xs font-semibold uppercase tracking-wider border border-blue-800 mb-6">
                ...
                <span>For Tanker Operators & Fleets</span>
              </div>
              ...
              <div className="space-y-2.5 mb-8 text-xs text-slate-300">
                <div className="flex items-center gap-2">
                  ...
                  <span>Central web dispatch and fleet oversight</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                  <span>Dedicated iOS & Android driver applications</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" />
                  <span>Configurable driver commission structures</span>
                </div>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in">
          <div className="bg-[#09152b] border border-cyan-500/30 rounded-3xl p-6 sm:p-8 max-w-lg w-full shadow-2xl relative">
            <button
              ...
              className="absolute top-5 right-5 text-slate-400 hover:text-white text-sm p-2 cursor-pointer"
            >
              ✕
            </button>
            ...
            {!submitted ? (
              <form onSubmit={handleSubmitInquiry} className="space-y-5">
                <div>
                  <h3 className="text-xl font-bold text-white font-display">Digitize Your Water Tanker Fleet</h3>
                ...
                <div className="space-y-3 text-xs">
                  <div>
                    <label className="text-slate-300 font-semibold block mb-1">Company / Fleet Name</label>
                    <input
                      type="text"
                      required
                      value={fleetName}
                      onChange={(e) => setFleetName(e.target.value)}
                      placeholder="e.g. Al-Riyadh Water Logistics"
                  ...
                  <div>
                    <label className="text-slate-300 font-semibold block mb-1">Active Tankers Count</label>
                    <select
                      value={tankerCount}
                      onChange={(e) => setTankerCount(e.target.value)}
                      className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-white focus:outline-none focus:border-cyan-400 text-xs"
                    >
                      <option value="1–4 tankers">1 – 4 Tankers (Independent)</option>
                      <option value="5–15 tankers">5 – 15 Tankers (Medium Fleet)</option>
                      <option value="16–50 tankers">16 – 50 Tankers (Commercial Fleet)</option>
                      <option value="50+ tankers">50+ Tankers (Enterprise Logistics)</option>
                    </select>
                  </div>

                  <div>
                    <label className="text-slate-300 font-semibold block mb-1">Contact Mobile Number (Saudi/GCC)</label>
                    <input
                      type="text"
                      required
                      value={contactNumber}
              ...
              <div className="text-center py-6 space-y-4">
                ...
                <div className="max-w-sm mx-auto p-2.5 rounded-xl bg-cyan-950/40 border border-cyan-500/30 flex items-center justify-center gap-2 text-xs font-mono text-cyan-300">
                  ...
                  <span>Notification sent to: <strong className="text-white">{TARGET_GMAIL}</strong></span>
                </div>
